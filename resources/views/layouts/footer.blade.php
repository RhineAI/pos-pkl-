      ...
      <section class="p-1 pt-0">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-7 col-lg-8 text-center text-md-start">
            ...
            <div class="p-3">
              © 2022 Copyright By:
              <a class="text-white" href="https://madtive.com/"
                 >Madtive Studio</a
                >
            </div>
            <!-- Copyright -->
          ...
          <div class="col-md-5 col-lg-4 ml-lg-0 text-center text-md-end">
            ...
            <a
               ...
               class="text-white"
               role="button"
               href="https://www.facebook.com/Madtive">
            ...
            <a
               ...
               class="text-white"
               role="button"
               href="https://twitter.com/madtive_studio"
            ...
            <a
               ...
               class="text-white"
               role="button"
               href="https://www.instagram.com/madtive_studio/"
